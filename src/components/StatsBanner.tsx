      ...
      <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-3">
        <div className="flex flex-wrap items-center gap-3">
          <div className="px-3 py-1 bg-slate-900 border border-slate-800 rounded-lg flex items-center space-x-2">
            ...
            <strong className="text-white font-bold">17 Published</strong>
          </div>
          <div className="px-3 py-1 bg-slate-900 border border-slate-800 rounded-lg flex items-center space-x-2">
            <Package className="w-3.5 h-3.5 text-cyan-400" />
            <span className="text-slate-400">NPM &amp; PyPI Packages:</span>
            <strong className="text-cyan-300 font-bold">17 Packages</strong>
          </div>
          <div className="px-3 py-1 bg-slate-900 border border-slate-800 rounded-lg flex items-center space-x-2">
            <Globe className="w-3.5 h-3.5 text-amber-400" />
            <span className="text-slate-400">Edge Gateways:</span>
            <strong className="text-amber-300 font-bold">12 Official Gateways</strong>
          </div>
          <div className="px-3 py-1 bg-slate-900 border border-slate-800 rounded-lg flex items-center space-x-2">
            <Cpu className="w-3.5 h-3.5 text-purple-400" />
            <span className="text-slate-400">Total MCP Tools:</span>
            <strong className="text-purple-300 font-bold">181 Autonomous Tools</strong>
          </div>
        </div>
        <button
