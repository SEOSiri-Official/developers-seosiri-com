...
import { Key, Check, Copy, ShieldCheck, Send, DollarSign, Lock, Unlock, Mail, ExternalLink, AlertCircle } from 'lucide-react';
...
export const ApiKeyGenerator: React.FC = () => {
  ...
  const ADMIN_PASSCODE = "seosiri2026"; // Simple passcode to unlock issuer form
    ...
    <div className="max-w-4xl mx-auto px-4 py-8 space-y-8 text-left">
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 sm:p-8 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="bg-slate-950 p-5 rounded-2xl border border-amber-500/30 rounded-2xl border space-y-3">
            <div className="flex items-center justify-between">
        ...
        <div className="bg-slate-950 p-6 rounded-2xl border border-slate-800 space-y-4">
          ...
          <ol className="text-xs text-slate-300 font-mono space-y-2.5 list-decimal pl-5 leading-relaxed">
            <li>
              ...
              <br />
              <strong className="text-emerald-400 text-sm bg-slate-900 px-2.5 py-1 rounded border border-slate-800 inline-block mt-1">badhan_pbn@yahoo.com</strong>
            </li>
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 sm:p-8 space-y-6">
        ...
        {!isAdminUnlocked ? (
          ...
          /* UNLOCKED ADMIN KEY ISSUER FORM */
