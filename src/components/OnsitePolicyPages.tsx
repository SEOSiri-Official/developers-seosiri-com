    ...
    <div className="max-w-5xl mx-auto px-4 py-8 space-y-8 text-left">
      ...
      {view === 'disclaimer' && (
        <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 sm:p-10 space-y-6">
          ...
          <p className="text-sm text-slate-300 leading-relaxed">
            All 15 open-source Model Context Protocol (MCP) packages, PyPI libraries, and Cloudflare Worker edge gateways published under <strong>SEOSiri-Official</strong> are provided "as-is" under the MIT Open Source License.
          </p>
